...
pub static INITCODE: [u8; 49] = [
    0x93, 0x08, 0x00, 0x01, // 0x01000893  li a7, 16   (SYS_write)
    0x13, 0x05, 0x10, 0x00, // 0x00100513  li a0, 1    (fd 1)
    0x93, 0x05, 0x00, 0x02, // 0x02000593  li a1, 32   (&msg)
    0x13, 0x06, 0x00, 0x01, // 0x01000613  li a2, 16   (len)
    0x73, 0x00, 0x00, 0x00, // 0x00000073  ecall
    0x93, 0x08, 0xb0, 0x00, // 0x00b00893  li a7, 11   (SYS_getpid)
    0x73, 0x00, 0x00, 0x00, // 0x00000073  ecall
    0x6f, 0xf0, 0x5f, 0xfe, // 0xfe5ff06f  j start     (offset -28)
